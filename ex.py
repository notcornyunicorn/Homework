...
f = open(r'/home/nastmak/mysite/table.txt', 'r', encoding = 'utf-8')
table = f.read()
words = table.split('\n')
f.close()
...
def send_len(message):
		i = 0
		question1 = 'Можно ли на вашем языке употребить слово "тупой" вместе со словом ' + words[i] + '?'
		question2 = 'Можно ли на вашем языке употребить слово "острый" вместе со словом ' + words[i] + '?'
